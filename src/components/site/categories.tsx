    ...
    <section className="bg-secondary/50 py-16">
      <div className="container-x">
        <div className="mb-10 text-center">
          <h2 className="font-serif text-3xl md:text-4xl">Shop by <span className="text-gold-dark">Category</span></h2>
          <p className="mt-2 text-sm text-muted-foreground">Explore our finest handcrafted collections</p>
        </div>
