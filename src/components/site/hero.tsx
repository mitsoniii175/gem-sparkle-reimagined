        ...
        <div className="container-x flex h-full flex-col justify-center">
          <div className="max-w-xl">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a href="#trending" className="rounded-full bg-primary px-7 py-3 text-sm font-medium text-primary-foreground transition-transform hover:scale-[1.03]">
                Shop Collection
              </a>
              <a href="#services" className="rounded-full border border-gold-dark px-7 py-3 text-sm font-medium text-gold-dark transition-colors hover:bg-primary hover:text-primary-foreground">
                Book a Visit
              </a>
            </div>
          </div>
