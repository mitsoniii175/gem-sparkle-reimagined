      ...
      <div className="container-x grid gap-10 py-14 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
            <li className="flex gap-2"><MapPin className="mt-0.5 h-4 w-4 shrink-0 text-gold-dark" /> Haldharvas Showroom, Gujarat</li>
            <li className="flex gap-2"><MapPin className="mt-0.5 h-4 w-4 shrink-0 text-gold-dark" /> Khatlal Showroom, Gujarat</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
            <li className="flex gap-2"><Phone className="h-4 w-4 text-gold-dark" /> {SITE.phone}</li>
            <li className="flex gap-2"><Mail className="h-4 w-4 text-gold-dark" /> {SITE.email}</li>
          </ul>
        </div>
      </div>
